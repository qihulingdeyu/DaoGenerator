...
public class Schema {
	 ...
	 * @param change
	 */
    public void enableChangeName(boolean change) {
		DaoUtil.changeName = change;
	}
    /**
     * 是否设置表名和字段名为大写，默认是大写
     * @param upperCase
     */
    public void setAllName2UpperCase(boolean upperCase) {
    	DaoUtil.toUpperCase = upperCase;
    }
     ...
     * @param classToExtend
     */
    public void setSuperclassOfAll(String classToExtend) {
    	this.classToExtend = classToExtend;
    }
    public String getSuperclassOfAll(){
    	if(classToExtend!=null && classToExtend.trim().equals("")) {
    		classToExtend = null;
    	}
